...
2. **Check that the symlink has actually been created.**
...
3. **Check that the file you're trying to import actually exists.**
...
4. **Ditch the dev servers and create production builds in both projects.**
