---
title: 'Tech roundup - Fri 30 June 2023'
description: 'AI
...
Toyota (yes that company lagging in EVs somehow cares about AI) rele'
pubDate: 'Jun 30 2023'
---
...
Artists have also been sharing what they've been able to achieve with Midjourney: check out the below example!
    ...
    >
>       [Galloping at Twilight](https://www.reddit.com/r/midjourney/comments/14kicck/galloping_at_twilight/)
>  by
>       [u/futurewham](https://www.reddit.com/user/futurewham) in
>       [midjourney](https://www.reddit.com/r/midjourney/)
>     

    
Spotify may be banning AI-generated music, but you can listen to examples on SoundCloud, including based on popular artists such as Drake and Ariana Grande:

![](https://artificialintelligenceradio.com/apple-touch-icon.png)

One Twitter user said he listened to it during his workouts; others are less convinced.

[Gleamer](https://www.gleamer.ai), a 5-year-old French AI startup has raised €27 million Series B funding. They makes software to help radiologists diagnose and detect bone trauma lesions in scans.
...
And a little gem from the [SEC filing suing Binance](https://www.sec.gov/news/press-release/2023-101):

### Now for some non-AI news!

Tesla's EV charging technology is on the fast track to become a US standard. Reuters [reports](https://www.reuters.com/business/autos-transportation/tesla-charging-technology-put-fast-track-become-us-industry-standard-2023-06-27/) that:
...
[Proton](https://proton.me) have released [Proton Pass](https://proton.me/pass), an open-source and encrypted password manager. It's nice to see them gradually building a suite of work tools as a privacy-first alternative to offerings by Big Tech. TechCrunch reviews it [here](https://techcrunch.com/2023/06/28/proton-launches-its-password-manager-proton-pass/).
...
- Engineers are trying to [build better air conditioners](https://www.wsj.com/articles/the-race-to-build-a-better-air-conditioner-601b28fc?mod=hp_lead_pos6). Given how bulky existing ones are, I'm all for this!
- [How Shazam Makes Unique Audio Fingerprints to Identify Songs](https://www.wsj.com/video/series/in-depth-features/how-shazam-makes-unique-audio-fingerprints-to-identify-songs/9D7E86B7-73EF-4B92-8726-162E62B0EA3A?mod=hp_lead_pos5) (Video)
- Apple has [uploaded](https://techcrunch.com/2023/06/27/apple-uploads-entire-first-episode-of-silo-on-twitter-ahead-of-season-finale/) the first episode of Silo to Twitter before they release the finale.
- [Microsoft wants to move Windows entirely to the cloud](https://www.theverge.com/2023/6/27/23775117/microsoft-windows-11-cloud-consumer-strategy)

A cool browser extension that I found out about this week is [StopTheMaddness](https://underpassapp.com/StopTheMadness/), which allows you to reverse stupid client-side code that websites add, such as blocking copy and paste in text fields "for security". 🙄
